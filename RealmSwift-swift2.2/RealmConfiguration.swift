...
extension Realm {
    ...
    public struct Configuration {
        ...
        */
        ...
        /// only be used on files which will be modified by anyone while they
        /// are open, and not just to get a read-only view of a file which may
        /// be written to by another thread or process. Opening in read-only
